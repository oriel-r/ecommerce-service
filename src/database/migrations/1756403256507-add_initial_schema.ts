...
export class AddInitialSchema1756403256507 implements MigrationInterface {
    name = 'AddInitialSchema1756403256507'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "shipping_method" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), CONSTRAINT "PK_b9b0adfad3c6b99229c1e7d4865" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`INSERT INTO "typeorm_metadata"("database", "schema", "table", "type", "name", "value") VALUES ($1, $2, $3, $4, $5, $6)`, ["db","public","product_variant","GENERATED_COLUMN","price","\n            CASE\n                WHEN \"discount_percentage\" > 0 AND \"discount_percentage\" < 100\n                THEN ROUND((\"list_price\" * (1 - \"discount_percentage\" / 100.0)), 2)\n                ELSE \"list_price\"\n            END\n        "]);
        await queryRunner.query(`CREATE TABLE "product_variant" ("createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "list_price" numeric(11,2) NOT NULL, "discount_percentage" smallint NOT NULL DEFAULT '0', "price" numeric(11,2) GENERATED ALWAYS AS (
            CASE
                WHEN "discount_percentage" > 0 AND "discount_percentage" < 100
                THEN ROUND(("list_price" * (1 - "discount_percentage" / 100.0)), 2)
                ELSE "list_price"
            END
        ) STORED NOT NULL, "stock" integer DEFAULT '999', "sku" character varying, "images" character varying array DEFAULT '{https://res.cloudinary.com/ddhx1kogg/image/upload/v1754159044/LOGO_SE_INSTALA_1_uj4wg0.png}', "option_name" character varying, "option_value" character varying, "weight" numeric(5,2), "is_default" boolean NOT NULL DEFAULT false, "product_id" uuid NOT NULL, CONSTRAINT "UQ_f4dc2c0888b66d547c175f090e2" UNIQUE ("sku"), CONSTRAINT "PK_1ab69c9935c61f7c70791ae0a9f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "address" ("createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "street" character varying NOT NULL, "postalCode" character varying NOT NULL, "apartment_floor" character varying, "country" character varying NOT NULL, "is_default" boolean NOT NULL DEFAULT 'false', "cityId" uuid, "memberId" uuid, CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_unique_default_address_per_member" ON "address" ("memberId") WHERE "is_default" IS TRUE`);
        await queryRunner.query(`CREATE TYPE "public"."member_taxcondition_enum" AS ENUM('Responsable Inscripto', 'Monotributo', 'Consumidor Final', 'Exento')`);
        await queryRunner.query(`CREATE TABLE "member" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "storeId" character varying NOT NULL, "fullName" character varying NOT NULL, "email" character varying NOT NULL, "birthDate" date NOT NULL, "password" character varying NOT NULL, "phoneNumber" character varying NOT NULL, "dni" character varying NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "cuit" character varying, "taxCondition" "public"."member_taxcondition_enum" DEFAULT 'Consumidor Final', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "roleId" uuid, CONSTRAINT "PK_97cbbe986ce9d14ca5894fdc072" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "store_configurations" ("createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "data" jsonb NOT NULL DEFAULT '{}', "store_id" uuid NOT NULL, CONSTRAINT "REL_5f2166a6832722a16929e990f7" UNIQUE ("store_id"), CONSTRAINT "PK_ee6d248397dea383cba50daca39" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "store_configurations" ADD CONSTRAINT "FK_5f2166a6832722a16929e990f73" FOREIGN KEY ("store_id") REFERENCES "store"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "store_configurations" DROP CONSTRAINT "FK_5f2166a6832722a16929e990f73"`);
        ...
        await queryRunner.query(`DROP TABLE "store_configurations"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."member_taxcondition_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_unique_default_address_per_member"`);
        await queryRunner.query(`DROP TABLE "address"`);
        await queryRunner.query(`DROP TABLE "orders"`);
        await queryRunner.query(`DROP TYPE "public"."orders_status_enum"`);
        await queryRunner.query(`DROP TABLE "order_items"`);
        await queryRunner.query(`DROP TABLE "product_variant"`);
        await queryRunner.query(`DELETE FROM "typeorm_metadata" WHERE "type" = $1 AND "name" = $2 AND "database" = $3 AND "schema" = $4 AND "table" = $5`, ["GENERATED_COLUMN","price","db","public","product_variant"]);
