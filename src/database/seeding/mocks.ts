...
export const productsMock: ProductMock[] = [
    {
        ...
        variants: [
            { isDefault: true, optionName: 'Tamaño', optionValue: '10cm', price: 3500.15 },
    ...
    },
    {
        ...
        variants: [
            {isDefault: true, optionName: 'Pack', 
    ...
    },
    {
        ...
        variants: [
            {isDefault: true, optionName: 'Ancho', optionValue: '12mm', price: 11500.00, discount: 15 },
    ...
    },
    {
        ...
        isFeatured: true,
        variants: [
            {isDefault: true, optionName: 'Material', optionValue: 'Metálico', price: 8800.00 },
    ...
    },
    {
        ...
        isFeatured: true,
        variants: [
            {isDefault: true, optionName: 'Contenido', optionValue: '250ml', price: 14500.00, },
    ...
    },
    {
        ...
        isFeatured: true,
        variants: [
            {isDefault: true, optionName: 'Ancho', optionValue: '10cm', price: 17800.00 },
        ]
    },
    {
    ...
    },
    {
        ...
        variants: [
            {isDefault: true, optionName: 'Pack', optionValue: 'x2 Unidades', price: 12500.00 },
        ]
    },
    {
        ...
        categories: ['Herramientas', 'Accesorios'],
        variants: [
            {isDefault: true, optionName: 'Pack', optionValue: 'Par', price: 4100.00 },
        ]
    },
    {
        ...
        variants: [
            {isDefault: true, optionName: 'Presentación', optionValue: 'Spray 1L', price: 24500.00 },
        ]
    },
    {
        ...
        categories: ['Herramientas', 'Espatulas'],
        variants: [
            {isDefault: true, optionName: 'Modelo', optionValue: 'Estándar', price: 5900.00 },
        ]
    },
    {
        ...
        categories: ['Herramientas', 'Pinzas'],
        variants: [
            {isDefault: true, optionName: 'Punta', optionValue: 'Recta', price: 4950.00 },
    ...
    },
    {
        ...
        categories: ['Herramientas', 'Otros'],
        variants: [
            {isDefault: true, optionName: 'Longitud', optionValue: '50cm', price: 19800.00 },
    ...
    },
    {
        ...
        isFeatured: true,
        variants: [
            {isDefault: true, optionName: 'Volumen', optionValue: '1L', price: 9800.00 },
    ...
    },
    {
        ...
        categories: ['Herramientas', 'Accesorios'],
        variants: [
            {isDefault: true, optionName: 'Ángulo', optionValue: '30°', price: 7200.00 },
    ...
    },
    {
        ...
        categories: ['Consumibles', 'Cintas'],
        variants: [
            {isDefault: true, optionName: 'Rollo', optionValue: '10mts', price: 13500.00 },
        ]
    },
    {
        ...
        categories: ['Herramientas', 'Espatulas'],
        variants: [
            {isDefault: true, optionName: 'Color', optionValue: 'Rosa', price: 2800.00 },
        ]
    },
    {
        ...
        categories: ['Consumibles', 'Pegamentos'],
        variants: [
            {isDefault: true, optionName: 'Lata', optionValue: '305g', price: 29800.00 },
        ]
    },
    {
        ...
        categories: ['Herramientas', 'Pinzas'],
        variants: [
            {isDefault: true, optionName: 'Tipo', optionValue: 'Anti-estática', price: 7900.00 },
        ]
    },
    {
        ...
        categories: ['Herramientas', 'Accesorios'],
        variants: [
            {isDefault: true, optionName: 'Marca', optionValue: 'Genérico', price: 45000.00 },
        ]
    },
    {
        ...
        categories: ['Herramientas', 'Otros'],
        variants: [
            {isDefault: true, optionName: 'Tipo', optionValue: 'Retráctil', price: 11200.00 },
        ]
    },
    {
        ...
        categories: ['Herramientas', 'Accesorios'],
        variants: [
            {isDefault: true, optionName: 'Capacidad', optionValue: '1.5L', price: 14900.00 },
        ]
    },
    {
        ...
        categories: ['Herramientas', 'Espatulas'],
        variants: [
            {isDefault: true, optionName: 'Dureza', optionValue: 'Blanda', price: 4200.00 },
    ...
    },
    {
        ...
        categories: ['Consumibles', 'Pegamentos'],
        variants: [
            { isDefault: true, optionName: 'Presentación', optionValue: '5g', price: 3900.00 },
        ]
    },
    {
        ...
        categories: ['Consumibles', 'Cintas'],
        variants: [
            {isDefault: true, optionName: 'Rollo', optionValue: '10mts', price: 8500.00 },
        ]
    },
    {
        ...
        categories: ['Herramientas', 'Accesorios'],
        variants: [
            {isDefault: true, optionName: 'Marca', optionValue: 'Genérica', price: 6200.00 },
        ]
    },
    {
        ...
        categories: ['Herramientas', 'Otros'],
        variants: [
            {isDefault: true, optionName: 'Longitud', optionValue: '40cm', price: 16500.00 },
        ]
    },
    {
        ...
        categories: ['Herramientas', 'Espatulas'],
        variants: [
            {isDefault: true, optionName: 'Tipo', optionValue: 'Estándar', price: 9900.00 },
        ]
    },
    {
        ...
        categories: ['Consumibles', 'Otros'],
        variants: [
            {isDefault: true, optionName: 'Marca', optionValue: 'Delta', price: 7500.00 },
        ]
    },
    {
        ...
        categories: ['Herramientas', 'Pinzas'],
        variants: [
            { isDefault: true, optionName: 'Tamaño', optionValue: '5 pulgadas', price: 12800.00 },
        ]
    }
]